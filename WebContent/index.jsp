...
<html>
	...
	<body>
		...
		<!-- Header -->
			<section id="header">
				<header class="major">
					<h1>The Tripsters Welcome You!</h1>
					<p>Have fun fiddling around.</p>
				</header>
				<div class="container">
					<ul class="actions">
			...
			<section id="one" class="main special">
				<div class="container">
					...
					<div class="content">
						...
						<p>I explore restaurants and bars !!!</p>
					</div>
			...
			<section id="two" class="main special">
				<div class="container">
					...
					<div class="content">
						...
						<p><form action = "display" method="get"> Source : <input type = "text" name="name"><br><br> <input type="submit" value="submit">
				</form></p>
						<ul class="icons-grid">
							<li>
